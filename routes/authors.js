...
router.get('/', async (req, res) => {
  if (req.user && req.user.email === 'admin@gmail.com') {
    // Only allow 'admin@gmail.com' to access the 'authors/index' page
    let searchOptions = {};
    if (req.query.name) {
    ...
    try {
      ...
      res.render('authors/indexuser', locals);
    } catch {
      res.redirect('/');
    }
  }
...
router.get('/:id', async (req, res) => {
  if (req.user && req.user.email === 'admin@gmail.com') {
    // Only allow 'admin@gmail.com' to access the 'authors/show' page
    try {
    ...
    try {
      ...
      res.render('authors/showuser', locals);
    } catch {
      res.redirect('/');
    }
  }
